...
export default function AlexeyWithPreloader() {
    ...
    useEffect(() => {
        ...
        return () => clearTimeout(hideBalloonsTimer);
    }, []);
        ...
        >
                ...
                <>
                    {Array.from({ length: 12 }).map((_, i) => (
                        <img
                            ...
                            src="https://system-informatics.iis.nsk.su/files/author/zubarevau.jpg"
                            alt="Смешной Алексей"
                            className="absolute w-16 h-16 rounded-full border-2 border-yellow-400 animate-float-up"
                            style={{
            ...
            <style jsx global>{`
                ...
                @keyframes fly {
                    ...
                    25% { transform: translate(90vw, 10vh) rotate(90deg); }
                    50% { transform: translate(60vw, 90vh) rotate(180deg); }
                    75% { transform: translate(10vw, 60vh) rotate(270deg); }
                    100% { transform: translate(0, 0); }
                }

                @keyframes title {
                    0% { letter-spacing: 0; transform: scale(1); }
                    50% { letter-spacing: 2px; transform: scale(1.05); }
                ...
                @keyframes pulse-border {
                    ...
                    70% { box-shadow: 0 0 0 20px rgba(255, 223, 0, 0); }
                ...
                @keyframes background-glow {
                    ...
                    100% { background-color: rgba(255, 255, 0, 0.05); }
                }
